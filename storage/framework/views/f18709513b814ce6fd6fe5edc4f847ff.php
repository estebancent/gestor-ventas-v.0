<?php
if (!function_exists('_f18709513b814ce6fd6fe5edc4f847ff')):
function _f18709513b814ce6fd6fe5edc4f847ff($__blaze, $__data = [], $__slots = [], $__bound = [], $__this = null) {
$__env = $__blaze->env;
...
<?php ob_start(); ?><?php echo e($label); ?><?php $__slots8f81587d357cea14a73bbab83867df22['slot'] = new \Illuminate\View\ComponentSlot(trim(ob_get_clean()), []); ?>
...
<?php _8f81587d357cea14a73bbab83867df22($__blaze, $__attrs8f81587d357cea14a73bbab83867df22, $__slots8f81587d357cea14a73bbab83867df22, ['attributes'], isset($this) ? $this : null); ?>
...
<?php ob_start(); ?><?php echo e($description); ?><?php $__slotse4e92fb9ed2eb060c4d674e410e03e63['slot'] = new \Illuminate\View\ComponentSlot(trim(ob_get_clean()), []); ?>
...
<?php _e4e92fb9ed2eb060c4d674e410e03e63($__blaze, $__attrse4e92fb9ed2eb060c4d674e410e03e63, $__slotse4e92fb9ed2eb060c4d674e410e03e63, ['attributes'], isset($this) ? $this : null); ?>
...
<?php _df54d2b6e0137c159e0bd1b0fdd712d5($__blaze, ['attributes' => new \Illuminate\View\ComponentAttributeBag($scope['attributes'])], [], ['attributes'], isset($this) ? $this : null); ?>
<?php $__blaze->popData(); ?>
...
<?php $__attrse4e92fb9ed2eb060c4d674e410e03e63 = ['attributes' => $descriptionAttributes]; ?>
<?php $__slotse4e92fb9ed2eb060c4d674e410e03e63 = []; ?>
<?php ob_start(); ?><?php echo e($descriptionTrailing); ?><?php $__slotse4e92fb9ed2eb060c4d674e410e03e63['slot'] = new \Illuminate\View\ComponentSlot(trim(ob_get_clean()), []); ?>
<?php $__blaze->pushData($__attrse4e92fb9ed2eb060c4d674e410e03e63); ?>
<?php $__blaze->pushSlots($__slotse4e92fb9ed2eb060c4d674e410e03e63); ?>
<?php _e4e92fb9ed2eb060c4d674e410e03e63($__blaze, $__attrse4e92fb9ed2eb060c4d674e410e03e63, $__slotse4e92fb9ed2eb060c4d674e410e03e63, ['attributes'], isset($this) ? $this : null); ?>
<?php if (isset($__slotsOriginal)) { $__slotse4e92fb9ed2eb060c4d674e410e03e63 = $__slotsOriginal; unset($__slotsOriginal); } ?>
...
<?php $__blaze->popData(); ?>
        <?php endif; ?>
    <?php $__slotsfd12a97005ce6dddf0320c1b5f085baa['slot'] = new \Illuminate\View\ComponentSlot(trim(ob_get_clean()), []); ?>
...
<?php _fd12a97005ce6dddf0320c1b5f085baa($__blaze, $__attrsfd12a97005ce6dddf0320c1b5f085baa, $__slotsfd12a97005ce6dddf0320c1b5f085baa, ['attributes'], isset($this) ? $this : null); ?>
